...
这个例子用来向读者解释零知识证明算法的“零知识性”是如何刻画的，这也正是用来证明“零知识性”的工具——**模拟（simulator）**。
...
- **二元关系**：TBD
- **图灵机**：[图灵机](https://baike.baidu.com/item/%E5%9B%BE%E7%81%B5%E6%9C%BA/2112989)
- **交互式证明**: TBD
- **不可区分**: TBD
...
### **1. 完备性（completeness）**
- 完备性可以简单地理解为，证明者P如果确实拥有知识，则P诚实地执行协议可以通过验证者V的验证。
### **2. 可靠性（soundness）**
- 可靠性可以简单地理解为，证明者P如果没有知识，则P不能通过验证者V的验证。而事实上，通过前文我们对于零知识证明协议的介绍可以知道，若P“运气足够好”，是有可能“猜出”答案从而骗过V的。所以对于可靠性更严格的说法应当为：证明者P如果没有知识，则P通过验证者V的验证的概率是**可忽略的**。
- 严谨的定义
- 证明的工具：知识提取器

### **3.零知识性（zero-knowledge）**
- 零知识性指，证明者P在交互过程中不会泄露关于知识的任何信息。
- 严谨的定义
- 证明的工具：模拟
