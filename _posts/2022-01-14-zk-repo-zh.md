...
我们相信**大部分信息已经在互联网上存在，只是需要被挑选和结构化地组织起来才能成为真正的知识**。借助 DAO 的力量，我们想创建一个持续更新的**零知识证明**的知识库目录，帮助更多开发人员登陆这些领域。

欢迎通过完成 ZK 相关的[**赏金任务**](https://dorahacksglobal.github.io/Hackathon-Playbook/playground/2021/11/10/bounties.html)贡献更多内容，或者提交 PR 到[**这个代码仓库**](https://github.com/dorahacksglobal/Hackathon-Playbook)分享任何你的想法和意见，DAO 成员会尽快帮忙审核。十分期待您的贡献 🌍💻💪
