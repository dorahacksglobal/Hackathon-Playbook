...
4. Once the wallet is connected (the wallet address should appear in the voting interface), key the amount you want to vote.
...
4. 连接钱包后（钱包地址会出现在投票界面中），输入您要投票的金额。
5. 点击“确认”完成。
